...
$D =$ {  
 ...
 $D_{Zigaretten} = \{Kools, Chesterfield, Old\text{ }Gold, Lucky\text{ }Strike, Parliament\}$  
}
...
$C = \{$  
 ...
 $c_7 = \{(Zigaretten, Haustier), Old\text{ }Gold = Schnecken\}$  
 $c_8 = \{(Zigaretten, Farbe), Kools = gelb\}$  
 $c_9 = \{(Getränk, Nummer), Milch = 3\}$  
 $c_{10} = \{(Nationalität, Nummer), Norweger = 1\}$  
 $c_{11} = \{(v_1: Haus(Zigaretten = Chesterfield), v_2: Haus(Haustier = Fuchs)), v_1.Nummer = v_2.Nummer \pm 1\}$  
 $c_{12} = \{(v_1: Haus(Zigaretten = Kools), v_2: Haus(Haustier = Pferd)), v_1.Nummer = v_2.Nummer \pm 1\}$  
 $c_{13} = \{(Zigaretten, Getränk), Lucky\text{ }Strike = O-Saft\}$  
 $c_{14} = \{(Nationalität, Zigaretten), Japaner = Parliaments\}$  
 $c_{15} = \{(v_1: Haus(Nationalität = Norweger), v_2: Haus(Farbe = blau)), v_1.Nummer = v_2.Nummer \pm 1\}$  
$\}$

## Framework für Constraint Satisfaction

[BT Search](BTSearch.py)
...
## Planung von Indoor-Spielplätzen
...
$C = \{$  
$c_1 = \{(Obj, x \in \text{Platzierte Obj}), \neg($  
$((Obj.PosX - 10) < x.PosX < (Obj.PosX + Obj.Breite + 10) \lor$  
$(Obj.PosX - 10) < (x.PosX + x.Breite) < (Obj.PosX + Obj.Breite + 10)) \land$  
$((Obj.PosY - 10) < x.PosY < (Obj.PosY + Obj.Hoehe + 10) \lor$  
$(Obj.PosY - 10) < (x.PosY + x.Hoehe) < (Obj.PosY + Obj.Hoehe + 10))$  
$)\}$  
$c_2 = \{Obj.Name = \text{Notausgang} \lor Obj.Name = \text{Eingang} \Rightarrow (Obj.PosX \in \{0, 1000\} \land Obj.Breite = 0) \lor (Obj.PosY \in \{0, 400\} \land Obj.Hoehe = 0)\}$  
$c_3 = \{\text{Der kürzeste Vektor zwischen der Bar und jedem Objekt, dass kein Notausgang oder Eingang ist darf nicht durch den Bereich eines anderen Objektes verlaufen.}\}$  
$\}$
