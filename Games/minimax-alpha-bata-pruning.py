...
def minimax(position, alpha, beta, is_maximizing_player):
    ...
    if is_maximizing_player:
        ...
        for child in position.children:
            evaluation = minimax(child, alpha, beta, False)
        ...
        min_eval = float('inf')
        for child in position.children:
            evaluation = minimax(child, alpha, beta, True)
...
if __name__ == "__main__":
    ...
    best_value = minimax(game_tree, float("-inf"), float("inf"), True)
